...
/** Controller class provides logic control for Modify Product screen.
 *
...
public class ModifyProductController implements Initializable {
    ...
    /** Initializes Modify Product controller and populates text fields
     * with the selected product from MainScreenController.
     *
    ...
    public void onAddButton(ActionEvent actionEvent) {
        Part selectedAssociatedPart = (Part) partTableView.getSelectionModel().getSelectedItem();
    ...
    public void onRemoveButton(ActionEvent actionEvent) {
        Part selectedAssociatedPart = (Part) assocPartTableView.getSelectionModel().getSelectedItem();
    ...
    /** Updates product in Inventory and loads MainScreenController.
    ...
    private void displayAlert(int alertType) {
        ...
        switch (alertType) {
            ...
            case 5:
                alertError.setTitle("Error");
                alertError.setHeaderText("Product NOT modified");
                alertError.setContentText("Invalid values or blank fields");
                alertError.showAndWait();
                break;
